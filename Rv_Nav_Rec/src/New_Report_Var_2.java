   ...
   public static void main(String args[])
   {
	...
	// TODO Auto-generated method stub
			...
			try
			{
				...
				String fileName = "/home/rv/Desktop/scheme_classification_avgmaturity_21102016.xlsx";
...
//						System.out.println();
				...
				PrintWriter writer = new PrintWriter("/home/rv/Desktop/New_Rep_Avg_Maturity_5.csv", "UTF-8"); 
				
				writer.println("Old_Scheme_Code"+","+"Scheme_COde"+","+"AMFI_NAME"+","+"S_NAME"+","+"TYPE_CODE"+","+"OTP_CODE"+","+"PRIMARY_FUND"+","+"PRIMARY_FD_CODE"+","+"STATUS"+","+"IS_PURCHASE_AVAILABLE"+","+"PLAN"+","+"DIV_CODE");
				...
				for(long sc_code :scheme_code_list)
				{
					   ...
					   crit.add(Restrictions.ne("STATUS", "Active"));
					   
					   
//					   crit.add(Restrictions.eq("PLAN",6));
//					   crit.add(Restrictions.eq("OPT_CODE",1));
					   
					    mn_lst = (ArrayList<Scheme_Detail>) crit.list();
					   
					   if(mn_lst.size()>0)
					   {
//						   writer.println(sc_code);
						   writer.println(sc_code+","+mn_lst.get(0).getScheme_code()+","+mn_lst.get(0).getAMFI_NAME()+","+mn_lst.get(0).getS_NAME()+","+mn_lst.get(0).getTYPE_CODE()+","+mn_lst.get(0).getOPT_CODE()+","+mn_lst.get(0).getPRIMARY_FUND()+","+mn_lst.get(0).getPRIMARY_FD_CODE()+","+mn_lst.get(0).getSTATUS()+","+mn_lst.get(0).getIsPurchaseAvailable()+","+mn_lst.get(0).getPLAN()+","+mn_lst.get(0).getDiv_Code());
...
//					   {
//						   System.out.println("=-=-=-=-==-=-=--=-=-==-=-=-=-=-=-=-=-=-=-=-=-=--=");
//						   System.out.println("Scheme-Code-->"+sc_code);
//						   System.out.println("Size->"+mn_lst.size());
//					   }
